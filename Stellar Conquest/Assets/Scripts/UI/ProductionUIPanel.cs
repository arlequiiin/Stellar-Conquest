...
public class ResourcesUI : MonoBehaviour {
    ...
    private void UpdateProductionRates() {
        uraniumProductionText.text = $"+{ResourceManager.Instance.UraniumProductionRate:F0}/с";
        energyProductionText.text = $"+{ResourceManager.Instance.EnergyProductionRate:F0}/с";
    }
}
